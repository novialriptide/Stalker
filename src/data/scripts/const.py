...
_sounds = {
    "open_window": engine.Sound(engine.resource_path("data/audio/game_window_open.mp3")),
    "close_window": engine.Sound(engine.resource_path("data/audio/game_window_close.mp3")),
    ...
    "footstep1": engine.Sound(engine.resource_path("data/audio/game_footstep1.mp3"), cooldown=500),
}
